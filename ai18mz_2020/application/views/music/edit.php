...
<?php echo form_input('performer',set_value('performer',$mus->performer),[ 'id' => 'performer',]); ?>
<?php echo form_error('performer');?>
<br/><br/>
<?php echo form_label('Title of the music:','title'); ?>
<?php echo form_input('title',set_value('title',$mus->title), ['placeholder' => 'title']); ?>
<?php echo form_error('title'); ?>
<br/><br/>
<?php echo form_label('Time:','time'); ?>
<?php echo form_input('time',set_value('time',$mus->time), ['placeholder' => 'time']); ?>
