...
<?php echo form_input('address',set_value('address',$film->address),[ 'id' => 'address',]); ?>
<?php echo form_error('address');?>
<br/><br/>
<?php echo form_label('Type of the film:','type_of'); ?>
<?php echo form_input('type_of',set_value('type_of',$film->type_of), ['placeholder' => 'type_of']); ?>
<?php echo form_error('type_of'); ?>
<br/><br/>
<?php echo form_label('Time:','time'); ?>
<?php echo form_input('time',set_value('time',$film->time), ['placeholder' => 'time']); ?>
